# File to be loaded into FEM2D.jl

"""
  DomainNorm(xy,cm,u;normID='Inf')
  
Computes either the L1, L2, or Linf norm on a given domain. Expects quadrilateral elements, and order 1 or 2 polynomial basis.
