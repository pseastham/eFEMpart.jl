...
function main()
  ...
  scatter!(p1,dtarr,L1arr,label="L1",color=:black,label="")
  scatter!(p1,dtarr,L2arr,label="L2",color=:black,label="")
  scatter!(p1,dtarr,LInfarr,label="Linf",color=:black,label="")
